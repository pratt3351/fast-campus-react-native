...
export const DiaryDetailScreen = ()=>{
    ...
    const date = useMemo(()=> new Date(route.params.item.date), [route.params.item]);
        ...
        <View style={{flex:1}}>
            ...
            <ScrollView style={{flex:1}}>
                ...
                {typeof route.params.item.photoUrl !== 'undefined' && (
                    ...
                    <RemoteImage url={route.params.item.photoUrl} width={photoSize.photoWidth} height={photoSize.photoHeight}/>
                )}
                <Spacer space={20}/>
